...
public class CallScreenActivity extends BaseActivity {
    ...
    public void onServiceConnected() {
        ...
        if (call != null) {
            ...
            mCallerName.setText(Global.partnerName);
    ...
    private void endCall() {
        ...
        if (Global.Afteractive) {
            finish();
        } else {
            Intent i=new Intent(CallScreenActivity.this,ChatActivity.class);
            startActivity(i);
            finish();
        }
    ...
    protected void onStart() {
        super.onStart();
        Global.Calleractive = true;
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Global.Calleractive = false;
    }
}
